              ...
              <Card className="bg-gray-900 border-gray-800">
                <CardContent className="pt-6">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <h2 className="text-xl font-bold text-white mb-1">{user?.username || "Usuário"}</h2>
                  ...
                  <Card className="bg-gray-900 border-gray-800 mt-6">
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="space-y-0.5">
                            <Label className="text-gray-300">Sessões Ativas</Label>
                            <p className="text-xs text-gray-500">
                              Gerencie dispositivos onde você está logado
                            </p>
                          </div>
                          <Button variant="outline" className="border-gray-700 text-gray-300 hover:text-white">
                            Gerenciar
                  ...
                  <Card className="bg-gray-900 border-gray-800 mt-6">
                    ...
                    <CardContent className="space-y-6">
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="space-y-0.5">
                            <Label className="text-gray-300">Notificações do Sistema</Label>
                            <p className="text-xs text-gray-500">
                        ...
                        <div className="flex items-center justify-between">
                          <div className="space-y-0.5">
                            <Label className="text-gray-300">Lembretes de Progresso</Label>
                            <p className="text-xs text-gray-500">
                              Receba lembretes sobre seu progresso nas trilhas
                            </p>
                          </div>
                          <Switch checked={true} />
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="space-y-0.5">
                            <Label className="text-gray-300">Atualizações de Conteúdo</Label>
                            <p className="text-xs text-gray-500">
                              Seja notificado quando novas trilhas forem adicionadas
                            </p>
                          </div>
                          <Switch checked={true} />
                        </div>
